...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7068DC);
  late Color secondary = const Color(0xFF91D048);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFAB91F8);
  ...
  late Color background = Color(0xFFF8F9FB);
