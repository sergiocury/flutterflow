...
import 'lojas_model.dart';
export 'lojas_model.dart';

class LojasWidget extends StatefulWidget {
  const LojasWidget({Key? key}) : super(key: key);

  @override
  _LojasWidgetState createState() => _LojasWidgetState();
}

class _LojasWidgetState extends State<LojasWidget> {
  late LojasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LojasModel());
  }
