...
class MeusProdutosWidget extends StatefulWidget {
  const MeusProdutosWidget({Key? key}) : super(key: key);

  @override
  _MeusProdutosWidgetState createState() => _MeusProdutosWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> meusProdutosUsersRowList = snapshot.data!;
        final meusProdutosUsersRow = meusProdutosUsersRowList.isNotEmpty
            ? meusProdutosUsersRowList.first
            : null;
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 40.0, 0.0, 0.0),
                                child: Text(
                                  'Para incluir um novo item para venda toque no botão \"+\" abaixo',
                                  maxLines: 3,
                                  style:
